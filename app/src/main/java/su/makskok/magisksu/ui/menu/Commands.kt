...
fun Commands(onBack: () -> Unit) {
    ...
    Column(modifier = Modifier
            ...
            Column(
                ...
                Row(
                    ...
                    IconButton(
                        onClick = {
                            output?.let {
                                clipboard.setText(AnnotatedString(it)); copied = true
                            }
                        },
                    ...
                    IconButton(
                        onClick = {
                            terminalWeight = if (terminalWeight < 1.2f) 1.8f else 0.8f
                        },
                        modifier = Modifier.size(36.dp)
                    ) {
                        Icon(
                    ...
                    IconButton(
                        onClick = {
                            output = null; activeCmd = null; terminalWeight = 0f; copied = false
                        },
                        modifier = Modifier.size(36.dp)
                    ) {
                        Icon(
        ...
        LazyColumn(
            modifier = Modifier.fillMaxWidth()
                .weight(
                    (if (terminalWeight > 0f) (2.8f - terminalWeight) else 1f).coerceAtLeast(
                        0.5f
                    )
                )
